    ...
    const r = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: 'Tu es Money Motor Y, conseiller stratégique d’investissement. Réponds en français avec: 1) Verdict chiffré (score/€/%), 2) Risques clés, 3) Plan d’action clair et exploitable en étapes.'
          },
